\documentclass{ouab}
% Options:
%   oneassigment - mode that suppresses table of contents for
%                  ABs containing only one assigment.
%                  Use \assignmentdetails{} to specify text in place
%                  of contents.
...
\abyear{2015}
%\assignmentdetails{This tutor-marked assignment covers Book A.} % For use with "oneassignment" option.
