...
%   studenttex   - outputs to tex file plain LaTeX solutions for
%                  distribution to ALs
...
\begin{enumerate}
\item One\marks{4}
\item $\int_0^\infty x$ and \[a^2=b^2=c^2\marks{2}\] 
Time to test marks: \marks{4M 1A} 

\item Marks with comments. \solnmarksplus{40}{Method}

hgjghjh gjh \marks 34
\end{enumerate}
also \mk 41
