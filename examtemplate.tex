...
You can display a mark but prevent it from getting added to the total and subtotal counters.\mk*[An alternative solution perhaps]{4}
...
Note that if you insert solutions per subquestion, then you cannot use the `solutionsonly' features.
\end{solution}
\end{enumerate}
\end{enumerate}
