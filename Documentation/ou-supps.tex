...
the same options as |\setSubtotalHline|, and they perform the analogous
tasks; the default |height| for the |subtotal| horizontal lines is |1pt|, 
...
\end{desc}
Adjusts the padding at the top of the title page to |<x>|. Default is |1cm|, and this should only be changed if you know what you're doing.
